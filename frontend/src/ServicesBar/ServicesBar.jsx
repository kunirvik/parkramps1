...
function MarqueeLabels({ items }) {
  // дублируем список для бесшовного зацикливания (сдвиг ровно на 50%)
  const doubled = [...items, ...items];

  return (
    <div className="marquee-wrap group relative w-full overflow-hidden">
