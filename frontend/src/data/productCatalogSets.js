...
const productCatalogSets = [
  ...
  },
  {
    ...
    designer: "СкейтДизайн",
    year: 2024,
    description2: " кожен мріє про свій спот це твоя іграшка на літо. за 11 років адміністрування скейтпарку ми знайшли формулу ідеального боксу це наша версія розбірного грайндбоксу посилений кожен елемент, фанера перміум класу, товстий профіль бокс зручний для перенесення, поміщається авто і в квартирі, як тобі комплектешурупи, викрутка та деталі боксу замовляй як зібраний так і в розборі Доставка новою поштою 840грн у будь-яку точку України під двері. збери бокс сам, або замов вже зібраним.",
