...
const productCatalogSets = [
...

  {
    ...
    description: "Комплекты для самостоятельного строительства элементов.",
    description2:
      "quater wall — квотер с наклонной стенкой, угол которой часто приближен к вертикали. Використовується для wallride-трюків, базового понимания проезда по большой фигуре и для обучения развороту без страха. Часто стає візуальною та функціональною особливістю скейтпарку, додаючи трасі складності та унікальності. Може встановлюватися як окрема секція або інтегруватися в рампи та комбіновані фігури.",
    details: [{ title: "Каталог фигур", link: "#catalog" }],
    relatedProducts: [1, 2, 3, 4],
  },
