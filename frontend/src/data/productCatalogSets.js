...
const productCatalogSets = [
    ...
    sample: [
      ...
      { type: "image", src: `${CLOUDINARY}v1783061430/jumpboxhatob_tyvaum.webp`},
      {
        ...
        caption: "підпис",
         ...
         specs: [
    { label: "Висота", value: "160см" },
    { label: "Ширина", value: "360 см" },
    { label: "Матеріал", value: " фанера / брус / cталь " },

  ],

    year: 2024,
    description2: "Комбінований елемент з двома заїздами та центральною платформою. Призначений для стрибків та контролю приземлення. Формує базову “повітряну” зону в лінії парку та підходить для прогресивного навчання трюків",
  ...
  },
  {
    ...
    sample: [
        { type: "image", src: `${CLOUDINARY}v1785165171/20260621_124337_i5tcck.jpg`, caption: "підпис 1" },
       { type: "image", src: `${CLOUDINARY}v1785165171/20260621_124322_eguuup.jpg`, caption: "підпис 1" },
    ...
    specs: [
    { label: "Висота", value: "25 см" },
    { label: "Ширина", value: "45 см" },
     { label: "Довжина", value: "121.5 см" },
    { label: "Матеріал", value: " фанера / брус / cталь " },
    // { label: "Товщина металу", value: "3 мм" },
  ],
    
  
    description2: "кожен мріє про свій спот це наша версія розбірного грайндбоксу. посилений кожен елемент, фанера перміум класу, товстий металевий профіль. бокс зручний для перенесення, поміщається в авто і в квартирі. все що потрібно йде в комплекті: шурупи, викрутка, деталі боксу та інструкція. замовляй як зібраний так і в розборі. доставка новою поштою у будь-яку точку України під двері.",
    description: "замовити можна за посиланням нижче. підберемо розміри, порахуємо вартість і зробимо проєкт під ваш майданчик.",
    relatedProducts: [1, 2, 4, 5],
  },
  {
    ...
    description2:
      "Радіусний елемент з переходом у майже вертикаль. Використовується для розгону, поворотів, виїздів у повітря та зв’язування секцій парку. Базовий модуль для побудови будь-якої лінійної або комбінованої траси. В залежности від умов та конфігурації парку може бути рызних розмірів",
